  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Container(
          ...
          child: ListView(
            children: [
              const Text('Your Cards', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
              const SizedBox(height: 10,),
              Text('You have ${controller.cards.length} ${controller.cards.length == 1? 'card' : 'cards'}',),
              Container(
